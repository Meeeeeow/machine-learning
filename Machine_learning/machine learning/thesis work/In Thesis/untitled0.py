...
df = pd.read_csv('dataset_primo_user_cleaned_data/Activity Class User1.csv');
counter = 0;
activity_count = 0;
day_count = 0;
...
date_list = [];
full_date_list=[];
full_activity_list=modified_df['Activity Class'];
...
for time in df['timestamp']:
    ...
    activity = df.iloc[activity_count]['Activity Class'];
...
print(unique_dates)        
#to csv
new_df.to_csv('dataset_primo_user_activity_counts/user1 activity count.csv');                  
